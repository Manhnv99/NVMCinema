INSERT INTO nvmcinema.area (id,code,created_at,deleted,name) VALUES
	 ('e3d23466-e107-4480-8137-3fde64a17bd4','HN','2026-04-13 00:00:00',1,'Hà Nội');

INSERT INTO nvmcinema.branch (id,address,code,created_at,deleted,email,hostline,image_id,image_url,name,area_id) VALUES
...
INSERT INTO nvmcinema.chair (id,code,created_at,deleted,max_row,name,status,room_id) VALUES
...
INSERT INTO nvmcinema.client (id,address_detail,birthday,code,created_at,deleted,email,image_id,image_url,name,password,phone_number,province,`role`) VALUES
...
INSERT INTO nvmcinema.combo_food (id,code,created_at,deleted,image_id,image_url,name,price) VALUES
...
INSERT INTO nvmcinema.country (id,code,created_at,deleted,name) VALUES
	 ('b4825cfc-cad6-4384-a3e6-693ee261a68f','CT1','2026-04-13 21:27:45.143000',1,'Việt Nam');
INSERT INTO nvmcinema.director (id,age,code,created_at,deleted,description,gender,name) VALUES
	 ('b10b66b6-6e76-4e05-982b-168dd96946ff',30,'DR1','2026-04-13 21:27:05.287000',1,'ABC',1,'Trấn Thành');
INSERT INTO nvmcinema.format (id,code,created_at,deleted,name) VALUES
	 ('e59107a4-6f49-4848-be0f-9cfa7d0e1a3f','FM1','2026-04-13 21:27:52.675000',1,'Full HD');
INSERT INTO nvmcinema.genre (id,code,created_at,deleted,name) VALUES
	 ('5c209878-c95f-4109-9381-6044e80fadbe','GR1','2026-04-13 21:27:29.364000',1,'Kinh Dị');
INSERT INTO nvmcinema.movie (id,actor,age_restriction,banner_id,banner_url,code,created_at,deleted,description,duration,name,release_date,subtitle,video_path,country_id,director_id,format_id,genre_id) VALUES
...
INSERT INTO nvmcinema.promotion_event (id,code,created_at,date_end,date_start,description,image_id,image_url,name,promotion_code,status,promotion_price) VALUES
...
INSERT INTO nvmcinema.room (id,code,created_at,deleted,name,branch_id) VALUES
	 ('294e5211-f216-47c6-80b9-fbf7b985dde7','ROOM1','2026-04-13 21:25:45.346000',1,'VIP1','e3d23466-e107-4480-8137-3fde64a17bd4');
INSERT INTO nvmcinema.showtime (id,created_at,deleted,screening_date,ticket_price,time_start,movie_id,room_id) VALUES
...
INSERT INTO nvmcinema.ticket_chair (id,chair_name,created_at,status,show_time_id) VALUES
...
INSERT INTO nvmcinema.users (id,address,birthday,cccd,code,created_at,email,gender,image_id,image_url,name,password,phone_number,`role`,status,area_id,branch_id) VALUES
