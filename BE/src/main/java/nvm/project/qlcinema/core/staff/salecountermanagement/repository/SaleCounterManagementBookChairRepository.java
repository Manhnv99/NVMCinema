...
import nvm.project.qlcinema.core.staff.salecountermanagement.model.response.SaleCounterManagementBookChairDetailShowTimeResponse;
import nvm.project.qlcinema.core.staff.salecountermanagement.model.response.SaleCounterManagementBookChairListTicketChairResponse;
...
@Repository
public interface SaleCounterManagementBookChairRepository extends TicketChairRepository {
    ...
    @Query(value = """
            ...
            """, nativeQuery = true)
    SaleCounterManagementBookChairDetailShowTimeResponse getDetailShowTime(String showTimeId);
    ...
    @Query(value = """
            ...
            """, nativeQuery = true)
    List<SaleCounterManagementBookChairListTicketChairResponse> getListTicketChair(String showTimeId);
