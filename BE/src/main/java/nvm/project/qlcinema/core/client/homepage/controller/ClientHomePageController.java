...
public class ClientHomePageController {
    ...
    @GetMapping("/list-movie-upcoming/{areaId}")
    public ResponseObject getListMovieUpComing(@PathVariable String areaId){
        return clientHomePageService.getListMovieUpComing(areaId);
    }
