...
export const GenreManagement = () => {
    ...
    //columns table
    const columns = [
        { title: "Mã Thể Loại", dataIndex: "code", key: "code" },
            ...
            render: (record) => {
                return (
                    <div className="cursor-pointer text-[16px]">
                        ...
                        <Tooltip title={record.status ? "Xóa thể loại" : "Hoạt động lại"} color="red">
                            <Button style={{ backgroundColor: "red", color: "#fff" }} onClick={() => {
                                Swal.fire({
                                    title: "Bạn có chắc muốn thay đổi trạng thái của thể loại này?",
                                    icon: "question",
            ...
            <div className="container mx-auto">
                <div className="shadow-xl rounded-[5px] px-[20px] py-[20px]">
                    ...
                    <Input
                        className="h-[50px]"
                        type="text"
                        placeholder="Tìm kiếm thể loại theo mã, tên..."
                        value={searchValue}
            ...
            <div className="mt-[50px]">
                <div className="flex justify-between items-center">
                    ...
                    <Button onClick={() => {
                        setOpenModalAddOrUpdate(true);
                        setWhatAction("post");
                    }} type="primary" className="h-[40px]">Thêm thể loại</Button>
                </div>
                <Table
                    className="mt-[10px]"
                    columns={columns}
