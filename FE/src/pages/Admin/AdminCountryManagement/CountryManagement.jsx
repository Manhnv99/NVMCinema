...
export const CountryManagement = () => {
    ...
    //columns table
    const columns = [
        { title: "Mã Đất Nước", dataIndex: "code", key: "code" },
        { title: "Tên Đất Nước", dataIndex: "name", key: "name" },
        {
                    ...
                    <div className="cursor-pointer text-[16px]">
                        ...
                        <Tooltip title={record.status ? "Xóa nhân viên" : "Hoạt động lại"} color="red">
                            <Button style={{ backgroundColor: "red", color: "#fff" }} onClick={() => {
                                Swal.fire({
                                    title: "Bạn có chắc muốn thay đổi trạng thái của đất nước này?",
                                    icon: "question",
            ...
            <div className="container mx-auto">
                <div className="shadow-xl rounded-[5px] px-[20px] py-[20px]">
                    ...
                    <Input
                        className="h-[50px]"
                        type="text"
                        placeholder="Tìm kiếm đất nước theo mã, tên..."
                        value={searchValue}
            ...
            <div className="mt-[50px]">
                <div className="flex justify-between items-center">
                    ...
                    <Button onClick={() => {
                        setOpenModalAddOrUpdate(true);
                        setWhatAction("post");
                    }} type="primary" className="h-[40px]">Thêm Đất Nước</Button>
                </div>
                <Table
                    className="mt-[10px]"
                    columns={columns}
