...
export const ComboFoodManagement = () => {
    ...
    const columns = [
        {
            title: "Ảnh Combo", dataIndex: "imageUrl", key: "imageUrl",
            render: (imageUrl) => (
                <Image
        ...
        {
            title: "Giá Combo", dataIndex: "price", key: "price",
            render: (price) => {
                return (
                    new Intl.NumberFormat().format(price) + "VNĐ"
                )
            }
        },
        {
            ...
            render: (record) => {
                return (
                    <div className="cursor-pointer text-[16px]">
                        ...
                        <Tooltip title={record.deleted ? "Xóa combo" : "Hoạt động lại"} color="red">
                            <Button style={{ backgroundColor: "red", color: "#fff" }} onClick={() => {
                                Swal.fire({
                                    title: "Bạn có chắc muốn thay đổi trạng thái của combo này?",
                                    icon: "question",
            ...
            <div className="mt-[50px]">
                <div className="flex justify-between items-center">
                    ...
                    <Button onClick={() => {
                        setOpenModalAddOrUpdate(true);
                        setWhatAction("post");
                    }} type="primary" className="h-[40px]">Thêm Combo</Button>
                </div>
                <Table
                    className="mt-[10px]"
                    columns={columns}
