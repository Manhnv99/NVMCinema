...
export const useFetchEntity = () => {
    ...
    const fetchListCountry = async () => {
        try {
            const response = await SaleCounterManagementAPI.fetchListCountry();
    ...
    const fetchListDirector = async () => {
        try {
            const response = await SaleCounterManagementAPI.fetchListDirector();
    ...
    const fetchListGenre = async () => {
        try {
            const response = await SaleCounterManagementAPI.fetchListGenre();
    ...
    const fetchListFormat = async () => {
        try {
            const response = await SaleCounterManagementAPI.fetchListFormat();
