...
export const useOrderManagement = () => {
    ...
    const handleFetchListSearchOrder = async (orderCode, date, timeStart, branchId, orderStatus, page) => {
        dispatchStore(setLoadingTrue());
        try {
            const response = await OrderManagementAPI.fetchListSearchOrder(orderCode, date, timeStart, branchId, orderStatus, page);
